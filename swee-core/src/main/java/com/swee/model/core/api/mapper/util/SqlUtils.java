package com.swee.model.core.api.mapper.util;
...
import static com.swee.model.core.api.mapper.constant.AuditField.IS_NOT_DELETED;
import static com.swee.model.core.api.mapper.constant.AuditField.UPDATED_AT_COLUMN_NAME;

import java.util.Set;
import javax.persistence.Version;
import org.apache.commons.lang3.StringUtils;
import com.swee.model.core.api.mapper.constant.AuditField;
...
//                    String versionClass = version.nextVersion().getCanonicalName();
    ...
    public static String wherePKColumns(Class<?> entityClass, boolean useVersion) {
        ...
        // delete flag
        sql.append(" AND ").append(IS_NOT_DELETED);
        //当某个列有主键策略时，不需要考虑他的属性是否为空，因为如果为空，一定会根据主键策略给他生成一个值
        for (EntityColumn column : columnList) {
